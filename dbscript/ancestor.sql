...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-11-03 06:23:42
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `files` (
  ...
  `createTime` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='帖子' AUTO_INCREMENT=192 ;
...
(190, '\r\n                  私人的\r\n                  \r\n', '其他', '其他', 1, '悬赏秘密', '', '深圳', '2015-10', '逃犯', '惠州嫌犯指认现场时戴镣铐逃脱', '10月30日，嫌犯被深圳警方带到博罗指认丢弃作案工具现场。', '跳车逃脱，穿囚服，戴手铐脚镣。身高1.65米贵州人中等身材。', '警方悬赏20万。', '潘明滩', 1, '21~25', '', '', 1, '蟋蟀', '2015-12-30', '', 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1, '2015-11-02 23:03:29'),
...
(95, '蟋蟀', 'knowledge', 1, 0, 1, 65, NULL, '广州', NULL, NULL, '0.6728981563355774.jpg', NULL, NULL, 1.01, 10),
